"""
- thanks fo github.com/CaitinZhao/cvpr2019_Pyramid-Feature-Attention-Network-for-Saliency-detection
"""
...
def logit(inputs):
    _epsilon = tf.convert_to_tensor(epsilon(), dtype=inputs.dtype.base_dtype)
